...
/**
 * A class that represents a text document It does one pass through
 * the document to count the number of syllables, words, and sentences
 * and then stores those values.
 * 
...
public class EfficientDocument extends Document {
	...
	private int numSentences; // The number of sentences in the
	                          // document
	private int numSyllables; // The number of syllables in the
	                          // document
	...
	/**
	 * Return true if this string is a word (as opposed to
	 * punctuation)
	 * 
	 * @param tok
	 *            The string to check
	...
	private boolean isWord(String tok) {
		// Note: This is a fast way of checking whether a string is a
		// word
	...
	/**
	 * Passes through the text one time to count the number of words,
	 * syllables and sentences, and set the member variables
	 * appropriately. Words, sentences and syllables are defined as
	 * described below.
	 */
	private void processText() {
		...
		// TODO: DONE Finish this method. Remember the countSyllables
		// method from
		// Document. That will come in handy here.
		int wordsInSentences = 0;
		for (String token : tokens) {
			final boolean isaWord = isWord(token);
			if (isaWord) {
				numWords++;
	...
	public int getNumWords() {
		// TODO: DONE write this method. Hint: It's simple
		return numWords;
	}
	...
	public static void main(String[] args) {
		...
		testCase(
		        new EfficientDocument("This is a test.  How many???  "
		...
		testCase(
		        ...
		        32, 15, 1);
		testCase(new EfficientDocument("Test .. . (. "), 1, 1, 3);
	}
